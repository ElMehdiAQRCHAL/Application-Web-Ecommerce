                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <form action="editerprofilA" method="post">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                    	<div class="mb-3 row">
    										...
    										<div class="col-sm-10">
      											<input type="text" class="form-control" id="inputname" name="Nom" value="<%=Admin.getNom() %>">
    										</div>
  										</div>
  										<div class="mb-3 row">
    										<label for="inputname" class="col-sm-2 col-form-label">PRENOM :</label>
    										<div class="col-sm-10">
      											<input type="text" class="form-control" id="inputname" name="Prenom" value="<%=Admin.getPrenom() %>">
    										</div>
  										</div>
  										<div class="mb-3 row">
    										<label for="inputname" class="col-sm-2 col-form-label">EMAIL :</label>
    										<div class="col-sm-10">
      											<input type="email" class="form-control" id="inputemail" name="Email" value="<%=Admin.getEmail() %>">
    										</div>
  										</div>
                                    	<div class="mb-3 row">
