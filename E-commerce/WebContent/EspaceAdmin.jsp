                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Marchands</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=Admins.nbM() %></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Clients</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=Admins.nbC() %></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-user fa-2x text-gray-300"></i>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Produits</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=Products.nb_Product() %></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Gains Marchands</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=commandes.gainsCommandelivre() %> MAD</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><%=commandes.nb_Commande() %></div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=commandes.nb_Commandelivre() %></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        <ul class="list-group list-group-flush">
  											<li class="list-group-item">ID ADMIN : <%=Admin.getId() %></li>
  											<li class="list-group-item">NOM : <%=Admin.getNom() %></li>
  											<li class="list-group-item">PRENOM : <%=Admin.getPrenom() %></li>
  											<li class="list-group-item">EMAIL : <%=Admin.getEmail() %></li>
										</ul>
                                    </div>
                                </div>
                            </div>
